...
async function handleExecuteScript(request: any, sendResponse: (response: any) => void) {
  try {
...
async function handleGetActiveTab(sendResponse: (response: any) => void) {
  try {
...
async function handleUpdateTab(request: any, sendResponse: (response: any) => void) {
  try {
